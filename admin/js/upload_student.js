//添加板块
var addstudent = document.getElementById('u_student');
var Sinput = addstudent.getElementsByTagName('input');
//上传
Sinput[1].onchange = function(){
	...
	xhr.open('post','/post_file_student.php',true);
	xhr.setRequestHeader('X-Request-With','XMLHttpRequest');
	var oFormdata = new FormData();
	oFormdata.append('file',Sinput[1].files[0]);
	xhr.send(oFormdata);
